...
const CONCEPT_RULES = [
  ...
  [/参考系/, '参考系是描述运动时选作标准的物体；选择不同参考系，对同一运动的描述可能不同，但都是正确的。'],
  [/质点/, '物体能否看作质点，取决于其形状和大小对所研究的问题是否可忽略，而不是物体本身的大小。'],
  [/圆周运动/, '匀速圆周运动线速度大小不变但方向时刻改变，故线速度矢量在变；角速度、周期、转速大小可保持不变。'],
  [/作用力与反作用力/, '作用力与反作用力大小相等、方向相反、作用在不同物体上，不能求合力；一对平衡力才作用在同一物体上。'],
  [/弹簧振子|振幅/, '弹簧振子的周期由劲度系数和质量决定，与振幅无关；振幅增大时最大速度、最大加速度增大。'],
  [/牛顿第/, '牛顿定律：惯性定律、F=ma、作用力与反作用力，分别对应力与运动关系的不同侧面。'],
  [/电场强度|电势/, '电场强度是矢量，描述电场力的性质；电势是标量，描述电场能的性质，沿电场线方向电势降低。'],
  [/安培力|洛伦兹/, '安培力是通电导线在磁场中受的力；洛伦兹力是运动电荷在磁场中受的力，都不做功（洛伦兹力）。'],
  [/电磁感应|楞次/, '楞次定律：感应电流的磁场总是阻碍引起感应电流的磁通量变化，本质是能量守恒。'],
  [/光的折射|折射率/, '折射率 n=sin i/sin r=c/v，介质中光速小于真空光速；全反射发生在光密射向光疏且入射角大于临界角时。'],
  [/动能定理/, '动能定理：合外力做功等于动能变化 W=ΔEk，适用于直线与曲线、恒力与变力。'],
  [/机械能守恒/, '机械能守恒条件：只有重力或弹力做功；有摩擦或其他力做功时机械能不守恒。'],
  [/欧姆定律|串并联/, '串联分压、并联分流；欧姆定律 I=U/R 只适用于纯电阻电路。'],
  [/加速度/, '加速度 a=Δv/Δt，方向与速度变化量方向相同；a 与 v 同向加速、反向减速。'],
];
...
for (const subject of Object.keys(eb).filter((k) => k !== 'meta')) {
  ...
  for (const q of eb[subject].exams || []) {
    ...
    // 通用模板选择题：空泛排除 或 “答案应选”占位
    const isGeneric = /其余选项：.*与题意不符/.test(a) || /答案应选/.test(a);
