...
var ExamSystem={
    ...
    addUIEntries:function(){
        ...
        document.addEventListener('DOMContentLoaded',function(){
            ['physics','chemistry','biology','chinese','math'].forEach(function(subject){
            ...
            window.loadModuleContent=function(subject,module){
                ...
                if(origLoad) origLoad(subject,module);
                    ...
                    console.error('考试系统加载模块失败('+subject+'/'+module+'):', err);
    ...
    buildExamAnalysis:function(){
        this.examAnalysis={
            ...
            chinese:{
                name:'语文',
                overallTrend:'2022-2026年广东高考语文卷命题趋势：注重语文学科核心素养，现代文阅读强调信息整合与批判性思维，文言文考查翻译与理解并重，作文注重思辨性与时代性，情境化命题成为主流',
                yearlyAnalysis:[
                    {year:2022,features:'现代文阅读考查论述类文本信息筛选，文言文考查人物传记翻译，作文为材料作文注重思辨。语言文字运用考查成语、病句、衔接',difficulty:0.52,hotTopics:['论述类文本阅读','文言文翻译','材料作文','成语病句']},
                    {year:2023,features:'现代文阅读增加文学类文本，文言文考查断句与概括，诗歌鉴赏考查表现手法，作文注重情境任务驱动',difficulty:0.50,hotTopics:['文学类文本阅读','文言文断句','诗歌表现手法','任务驱动型作文']},
                    {year:2024,features:'现代文阅读融合信息类与文学类，文言文考查比较阅读，语言文字运用创新题型增多，作文强调思辨深度',difficulty:0.49,hotTopics:['信息+文学融合阅读','文言文比较阅读','语言运用创新题','思辨型作文']},
                    {year:2025,features:'核心素养导向更明显，整本书阅读考查比重增大，文言文注重文化传承，作文注重现实关怀与批判思维',difficulty:0.48,hotTopics:['整本书阅读','文化传承文言文','现实关怀作文','信息整合能力']},
                    {year:2026,features:'情境化命题成主流，跨媒介阅读考查增多，文言文注重学以致用，作文强调多元思辨与表达创新',difficulty:0.47,hotTopics:['跨媒介阅读','学以致用文言文','多元思辨作文','表达创新']}
                ],
                frequency:[
                    {topic:'现代文阅读(论述类/实用类)',frequency:5,difficulty:'中',type:'选择+简答',trend:'每年必考，注重信息筛选与推断'},
                    {topic:'现代文阅读(文学类)',frequency:5,difficulty:'中偏难',type:'简答',trend:'注重赏析与探究，开放性增强'},
                    {topic:'文言文翻译',frequency:5,difficulty:'中偏难',type:'翻译',trend:'每年必考，注重实词虚词与句式'},
                    {topic:'文言文断句与概括',frequency:4,difficulty:'中',type:'简答',trend:'断句题近年增多'},
                    {topic:'诗歌鉴赏',frequency:5,difficulty:'中偏难',type:'简答',trend:'注重表现手法与情感分析'},
                    {topic:'名句默写',frequency:5,difficulty:'易偏中',type:'填空',trend:'每年必考，60篇必背'},
                    {topic:'语言文字运用',frequency:5,difficulty:'中',type:'选择+简答',trend:'成语、病句、衔接、图文转换'},
                    {topic:'作文',frequency:5,difficulty:'难',type:'写作',trend:'60分大题，思辨性与时代性并重'}
                ],
                scoreDistribution:[
                    {section:'现代文阅读',score:36,proportion:'24%',note:'论述类+文学类共36分'},
                    {section:'古代诗文阅读',score:34,proportion:'23%',note:'文言文+诗歌+默写共34分'},
                    {section:'语言文字运用',score:20,proportion:'13%',note:'成语、病句、衔接等'},
                    {section:'作文',score:60,proportion:'40%',note:'材料作文/任务驱动型作文'}
                ]
            },
            math:{
                name:'数学',
                overallTrend:'2022-2026年广东高考数学卷命题趋势：新高考结构稳定，注重数学核心素养，函数与导数仍是压轴大题，概率统计考查情境化，立体几何注重空间想象与推理，选择题减少计算量增大思维量',
                yearlyAnalysis:[
                    {year:2022,features:'新高考结构，单选8题+多选3题+填空3题+解答5题。函数导数为压轴，概率统计考查回归分析，立体几何建系法为主',difficulty:0.52,hotTopics:['函数与导数','概率统计','立体几何','三角函数']},
                    {year:2023,features:'难度较2022年提升，多选题评分规则优化（部分正确得部分分），圆锥曲线计算量增大，数列考查创新题型',difficulty:0.50,hotTopics:['圆锥曲线','数列创新题','导数综合','多选题策略']},
                    {year:2024,features:'命题更注重思维品质，减少机械计算，概率统计融入真实情境，立体几何考查翻折问题，函数性质综合考查',difficulty:0.49,hotTopics:['翻折问题','情境化概率统计','函数性质综合','圆锥曲线离心率']},
                    {year:2025,features:'核心素养导向明显，开放性试题增多，数学文化融入命题，导数考查不等式证明，数列与不等式综合',difficulty:0.48,hotTopics:['数学文化','导数不等式证明','数列与不等式','开放性试题']},
                    {year:2026,features:'情境化命题成主流，跨模块综合题增多，注重数学建模能力，概率统计与函数融合，圆锥曲线注重定义法',difficulty:0.47,hotTopics:['数学建模','概率与函数融合','圆锥曲线定义法','跨模块综合']}
                ],
                frequency:[
                    {topic:'函数与导数',frequency:5,difficulty:'难',type:'解答',trend:'每年必考压轴题，含零点、最值、不等式'},
                    {topic:'三角函数与解三角形',frequency:5,difficulty:'中',type:'选择+解答',trend:'每年必考，注重图像与性质'},
                    {topic:'数列',frequency:5,difficulty:'中偏难',type:'选择+解答',trend:'通项、求和、创新题型'},
                    {topic:'立体几何',frequency:5,difficulty:'中偏难',type:'选择+解答',trend:'平行垂直证明+空间角计算'},
                    {topic:'圆锥曲线',frequency:5,difficulty:'难',type:'解答',trend:'离心率、方程、面积、最值'},
                    {topic:'概率统计',frequency:5,difficulty:'中',type:'选择+解答',trend:'情境化命题，回归分析/分布列'},
                    {topic:'不等式',frequency:4,difficulty:'中',type:'选择+填空',trend:'基本不等式应用'},
                    {topic:'向量',frequency:4,difficulty:'中',type:'选择+填空',trend:'数量积、模、夹角'},
                    {topic:'复数',frequency:4,difficulty:'易',type:'选择',trend:'四则运算、模'},
                    {topic:'集合与逻辑',frequency:4,difficulty:'易',type:'选择',trend:'集合运算、充分必要条件'},
                    {topic:'二项式定理',frequency:3,difficulty:'中',type:'选择+填空',trend:'展开式、指定项'},
                    {topic:'排列组合',frequency:3,difficulty:'中',type:'选择+填空',trend:'分类分步、捆绑插空'}
                ],
                scoreDistribution:[
                    {section:'单项选择题(1-8)',score:40,proportion:'27%',note:'每题5分'},
                    {section:'多项选择题(9-11)',score:18,proportion:'12%',note:'每题6分，部分正确得3分'},
                    {section:'填空题(12-14)',score:15,proportion:'10%',note:'每题5分'},
                    {section:'解答题(15-19)',score:77,proportion:'51%',note:'三角/数列/立体/概率/圆锥/导数'}
                ]
            }
        };
    },
    ...
    buildReviewRound1:function(){
        this.reviewRound1={
            ...
            chinese:{
                name:'语文',
                description:'一轮复习：系统梳理语文知识体系，从基础知识到阅读写作全面提升',
                schedule:[
                    {phase:'第1-2周',topic:'论述类与实用类文本阅读',keyPoints:['论述类文本论点论据分析','实用类文本信息筛选与概括','选择题常见设错方式','简答题答题规范'],difficulty:'基础→中等',exercises:15},
                    {phase:'第3-4周',topic:'文学类文本阅读',keyPoints:['小说人物形象分析','小说主题与环境','散文结构与主旨','现代诗歌鉴赏'],difficulty:'中等→较难',exercises:12},
                    {phase:'第5-6周',topic:'文言文阅读',keyPoints:['实词虚词积累','文言特殊句式','文言文翻译方法','断句与概括'],difficulty:'中等→较难',exercises:12},
                    {phase:'第7-8周',topic:'诗歌鉴赏',keyPoints:['诗歌意象与意境','表现手法分类','思想情感分析','比较鉴赏方法'],difficulty:'中等→较难',exercises:12},
                    {phase:'第9-10周',topic:'名句默写与古代文化常识',keyPoints:['60篇必背篇目梳理','易错字辨析','古代文化常识积累','理解性默写训练'],difficulty:'基础→中等',exercises:15},
                    {phase:'第11-12周',topic:'语言文字运用',keyPoints:['成语辨析','病句辨析与修改','语句衔接与连贯','图文转换与仿写'],difficulty:'中等',exercises:12},
                    {phase:'第13-14周',topic:'作文（一）审题立意与结构',keyPoints:['材料作文审题方法','立意角度选择','议论文结构模式','素材积累与运用'],difficulty:'中等→较难',exercises:8},
                    {phase:'第15-16周',topic:'作文（二）思辨与语言提升',keyPoints:['思辨性写作训练','任务驱动型作文','语言文采提升','考场作文时间管理'],difficulty:'较难',exercises:8}
                ]
            },
            math:{
                name:'数学',
                description:'一轮复习：全面覆盖高中数学所有知识点，建立完整知识网络，强化基础方法',
                schedule:[
                    {phase:'第1-2周',topic:'集合、逻辑与不等式',keyPoints:['集合的概念与运算','充分条件与必要条件','一元二次不等式','基本不等式'],difficulty:'基础→中等',exercises:15},
                    {phase:'第3-4周',topic:'函数的概念与性质',keyPoints:['函数定义域值域','单调性与奇偶性','周期性与对称性','函数图像变换'],difficulty:'中等→较难',exercises:12},
                    {phase:'第5-6周',topic:'基本初等函数',keyPoints:['指数函数与对数函数','幂函数','分段函数','函数与方程'],difficulty:'中等→较难',exercises:12},
                    {phase:'第7-8周',topic:'三角函数与解三角形',keyPoints:['三角恒等变换','正弦余弦函数图像与性质','正弦定理与余弦定理','解三角形综合'],difficulty:'中等',exercises:12},
                    {phase:'第9-10周',topic:'数列',keyPoints:['等差数列与等比数列','通项公式求法','前n项和求法','数列综合应用'],difficulty:'中等→较难',exercises:12},
                    {phase:'第11-12周',topic:'立体几何',keyPoints:['空间线面位置关系','平行与垂直证明','空间向量与建系法','空间角与距离计算'],difficulty:'较难',exercises:10},
                    {phase:'第13-14周',topic:'平面解析几何',keyPoints:['直线与圆的方程','椭圆双曲线抛物线定义与方程','离心率与轨迹方程','直线与圆锥曲线位置关系'],difficulty:'较难',exercises:10},
                    {phase:'第15-16周',topic:'概率统计与导数',keyPoints:['排列组合与二项式定理','概率与分布列','统计与回归分析','导数运算与应用'],difficulty:'中等→较难',exercises:10}
                ]
            }
        };
    },
    ...
    buildReviewRound2:function(){
        this.reviewRound2={
            ...
            chinese:{
                ...
                description:'二轮专题复习：针对高考重点题型和综合能力进行专项突破',
                topics:[
                    {title:'专题一：现代文阅读综合突破',core:'论述类+文学类信息整合与深度理解',keyModels:['论述类选择题陷阱识别','信息筛选概括方法','小说人物主题环境三维分析','散文结构与主旨把握'],typicalQuestions:['论述类信息推断题','小说人物形象与主题分析'],difficulty:'中偏难',guangdongFrequency:'★★★★★'},
                    {title:'专题二：文言文阅读综合突破',core:'实词虚词+翻译+断句+概括',keyModels:['常见实词推断方法','虚词用法辨析','特殊句式翻译技巧','文化常识与断句'],typicalQuestions:['文言文翻译题','文言文概括分析题'],difficulty:'中偏难',guangdongFrequency:'★★★★★'},
                    {title:'专题三：诗歌鉴赏专项',core:'意象+手法+情感+比较',keyModels:['意象意境分析方法','表现手法分类与术语','情感分析答题模式','比较鉴赏方法'],typicalQuestions:['表现手法赏析题','情感分析题'],difficulty:'中偏难',guangdongFrequency:'★★★★☆'},
                    {title:'专题四：名句默写与语言运用',core:'60篇默写+成语病句+衔接仿写',keyModels:['理解性默写方法','成语辨析方法','病句类型与修改','语句衔接与图文转换'],typicalQuestions:['理解性默写','病句修改与成语运用'],difficulty:'中等',guangdongFrequency:'★★★★★'},
                    {title:'专题五：作文专项突破',core:'审题立意+结构模式+思辨提升',keyModels:['材料作文审题立意方法','议论文结构模式（并列/递进/对照）','思辨性写作方法','任务驱动型作文'],typicalQuestions:['材料作文写作','任务驱动型作文'],difficulty:'难',guangdongFrequency:'★★★★★'},
                    {title:'专题六：信息类文本与跨媒介阅读',core:'信息整合+批判性思维+跨媒介',keyModels:['多则材料信息整合','批判性阅读方法','跨媒介阅读策略','图表数据分析'],typicalQuestions:['多材料信息概括','跨媒介阅读题'],difficulty:'中偏难',guangdongFrequency:'★★★★☆'}
                ]
            },
            math:{
                name:'数学',
                description:'二轮专题复习：针对高考重点题型和综合能力进行专项突破',
                topics:[
                    {title:'专题一：函数与导数综合',core:'函数性质+导数应用+不等式证明',keyModels:['函数零点与方程','导数研究单调性','导数证明不等式','极值与最值综合'],typicalQuestions:['导数压轴题（含e^x, ln x）','函数零点问题'],difficulty:'难',guangdongFrequency:'★★★★★'},
                    {title:'专题二：圆锥曲线综合',core:'定义+方程+离心率+直线与圆锥曲线',keyModels:['定义法解题','离心率范围','轨迹方程求法','弦长面积最值'],typicalQuestions:['直线与椭圆综合','圆锥曲线最值问题'],difficulty:'难',guangdongFrequency:'★★★★★'},
                    {title:'专题三：立体几何综合',core:'线面关系+空间向量+翻折问题',keyModels:['平行垂直证明（综合法）','建系法求空间角','翻折问题分析','外接球与内切球'],typicalQuestions:['线面角与二面角','翻折问题'],difficulty:'中偏难',guangdongFrequency:'★★★★★'},
                    {title:'专题四：概率统计综合',core:'排列组合+概率+分布列+回归',keyModels:['古典概型与条件概率','离散型随机变量分布列','正态分布应用','线性回归与独立性检验'],typicalQuestions:['分布列与期望计算','回归分析题'],difficulty:'中偏难',guangdongFrequency:'★★★★★'},
                    {title:'专题五：三角与数列综合',core:'三角变换+解三角形+数列通项与求和',keyModels:['三角恒等变换技巧','解三角形综合','数列通项构造法','数列求和方法（裂项/错位/分组）'],typicalQuestions:['解三角形综合题','数列求和综合'],difficulty:'中等',guangdongFrequency:'★★★★☆'},
                    {title:'专题六：选择填空专项突破',core:'高频选择填空题型集中训练',keyModels:['集合与逻辑','复数与向量','函数图像与性质','不等式与二项式'],typicalQuestions:['选择题速解技巧','填空题易错点'],difficulty:'中等',guangdongFrequency:'★★★★★'}
                ]
            }
        };
    },
    ...
    buildQuizEngine:function(){
        this.quizEngine={
            ...
            chinese:[
                {id:'ch1',type:'single',difficulty:1,chapter:'名句默写',question:'"床前明月光"的作者是',options:['杜甫','李白','白居易','王维'],answer:1,explanation:'《静夜思》作者为李白，全诗为"床前明月光，疑是地上霜。举头望明月，低头思故乡。"'},
                {id:'ch2',type:'single',difficulty:2,chapter:'诗歌鉴赏',question:'下列对"国破山河在，城春草木深"的赏析，正确的是',options:['表现了国家繁荣昌盛的景象','以乐景写哀情，反衬国破家亡之痛','纯写自然景色，无感情色彩','运用了拟人手法'],answer:1,explanation:'此句出自杜甫《春望》，以"山河在""草木深"的自然景象反衬"国破"的凄凉，以乐景写哀情'},
                {id:'ch3',type:'single',difficulty:2,chapter:'文言文翻译',question:'"何陋之有"的句式是',options:['判断句','被动句','宾语前置','定语后置'],answer:2,explanation:'"何陋之有"即"有何陋"，"之"为宾语前置的标志，正常语序为"有何陋"，属于宾语前置句'},
                {id:'ch4',type:'single',difficulty:1,chapter:'成语运用',question:'下列句子中成语使用正确的是',options:['他做事总是虎头蛇尾，令人放心','这篇文章文不加点，一气呵成','他对人总是侃侃而谈，非常谦虚','这道题他百思不解其义'],answer:1,explanation:'"文不加点"形容文思敏捷，写作技巧纯熟。A项"虎头蛇尾"指做事有始无终，与"令人放心"矛盾；C项"侃侃而谈"指理直气壮地直言，不表谦虚'},
                {id:'ch5',type:'single',difficulty:3,chapter:'现代文阅读',question:'论述类文本阅读中，下列属于"偷换概念"的是',options:['将"可能"表述为"一定"','将"部分"表述为"全部"','将A概念替换为B概念','将"原因"表述为"结果"'],answer:2,explanation:'偷换概念是指在论述过程中将一个概念替换为另一个不同的概念。A为"绝对化"，B为"以偏概全"，D为"因果倒置"'},
                {id:'ch6',type:'single',difficulty:2,chapter:'作文',question:'材料作文审题时，最核心的步骤是',options:['背诵范文','提取材料关键词并分析逻辑关系','字数达到800字','使用排比句'],answer:1,explanation:'材料作文审题核心是提取关键词、分析材料逻辑关系，确定最佳立意角度。背诵范文和追求字数/句式不是审题核心'},
                {id:'ch7',type:'single',difficulty:1,chapter:'名句默写',question:'"但愿人长久，______"的下一句是',options:['千里共婵娟','天涯共此时','万里共明月','千里共明月'],answer:0,explanation:'苏轼《水调歌头》："但愿人长久，千里共婵娟。"婵娟指月亮，表达对远方亲人的美好祝愿'}
            ],
            math:[
                {id:'m1',type:'single',difficulty:1,chapter:'集合',question:'设集合A={1,2,3}，B={2,3,4}，则A∩B=',options:['{1}','{2,3}','{1,2,3,4}','{4}'],answer:1,explanation:'A∩B取两集合的公共元素，A={1,2,3}与B={2,3,4}的公共元素为2和3，故A∩B={2,3}'},
                {id:'m2',type:'single',difficulty:2,chapter:'函数',question:'函数f(x)=ln(x-1)+√(4-x)的定义域为',options:['(1,4]','(1,4)','[1,4]','(1,+∞)'],answer:0,explanation:'需x-1>0且4-x≥0，即x>1且x≤4，定义域为(1,4]'},
                {id:'m3',type:'single',difficulty:2,chapter:'三角函数',question:'函数f(x)=sin(2x+π/6)的最小正周期为',options:['π/2','π','2π','4π'],answer:1,explanation:'f(x)=sin(2x+π/6)中ω=2，周期T=2π/ω=2π/2=π'},
                {id:'m4',type:'single',difficulty:3,chapter:'导数',question:'函数f(x)=x³-3x在x=1处的导数值为',options:['-1','0','1','3'],answer:1,explanation:'f′(x)=3x²-3，f′(1)=3×1-3=0。此时x=1为函数的驻点（极大值点）'},
                {id:'m5',type:'single',difficulty:2,chapter:'数列',question:'等差数列{aₙ}中，a₁=2，a₃=6，则a₅=',options:['8','10','12','14'],answer:1,explanation:'a₃=a₁+2d→6=2+2d→d=2。a₅=a₁+4d=2+4×2=10'},
                {id:'m6',type:'single',difficulty:3,chapter:'圆锥曲线',question:'椭圆x²/4+y²/9=1的离心率为',options:['√5/3','√13/3','√5/2','2/3'],answer:0,explanation:'a²=9→a=3，b²=4→b=2，c=√(a²-b²)=√5。离心率e=c/a=√5/3'},
                {id:'m7',type:'single',difficulty:1,chapter:'概率',question:'掷一枚骰子，出现偶数点的概率为',options:['1/6','1/3','1/2','2/3'],answer:2,explanation:'骰子共有6个面，偶数点为2、4、6共3个，概率=3/6=1/2'}
            ]
        };
        this.errorBook={physics:[],chemistry:[],biology:[],chinese:[],math:[]};
    },
    ...
    renderQuiz:function(subject){
        ...
        var subjectNames={physics:'物理',chemistry:'化学',biology:'生物',chinese:'语文',math:'数学'};
